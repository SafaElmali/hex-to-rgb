...
const Header = ({ setValue, value, setColor, setSearchList, color }) => {
  ...
  const handleKeyPress = (event) =>
    event.key === "Enter" ? handleConvert() : null;
          ...
          <div className="col-md-4 mx-auto mt-3">
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ref={input}
                type="text"
                className="form-control input-props"
                placeholder="e.g 282C34"
                maxLength="6"
              ...
              />
              <i
                className="fas fa-search search-icon-props"
                onClick={() => convertHexToRgb(value)}
